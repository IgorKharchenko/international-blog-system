...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 04 2016 г., 11:35
...
(2, 'User002', 'Hola, amigo!\r\nUpdated\r\nUpdated by Admin', 1, 2, 1457008156),
(3, 'Admin Comment', 'Writed by Administrator', 1, 2, 1457012151),
(4, 'User001 Comment', 'Can I delete my own comment?', 2, 2, 1457012188),
(5, '??!!', '<p>Да я никогда в жизни не поверю, что русские танки способны на такое!</p>\r\n', 7, 5, 1457078588),
(6, 'Не соглашусь с Вами', '<p>Не согласен с Вашей точки зрения, Михаил. Мощь российской армии способна на многое!</p>\r\n\r\n<p><em>далее должна быть представлена&nbsp;развёрнутая аргументация с ссылками на источники</em></p>\r\n', 1, 5, 1457078630);
...
(1, 'Admin', '$2y$13$2x/w7hlU.SzFc5wm0AICXORTYiDpLJThlB76ol/17x2ewtSfC7bNe', NULL, 'admin@yii.local', 'thX7LKVqt-def2lwIScoMH4v_Ho9vfhz', 10, 1456991345, 1456991345),
(7, 'Mikhail Lavrentiev', '$2y$13$B9JNw0XBAS3zdoCrkv/6weVG3pze6QUzey.kulRRLKAqLxt8CK/5m', NULL, 'mikhail.lavrentiev@backmeup.cz', 'SRD5Dw-yxQ0V_MPkJNSJcXwo_5wGcuYQ', 10, 1457078515, 1457078515);

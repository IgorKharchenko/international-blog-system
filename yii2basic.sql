...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 04 2016 г., 18:15
...
(5, '??!!', '<p>Да я никогда в жизни не поверю, что КНДР способна на такое!</p>\n', 7, 5, 1457078588),
(6, 'Не соглашусь с Вами', '<p>Не согласен с Вашей точки зрения, Михаил. Мощь севернокорейской армии способна на многое!</p>\r\n\r\n<p><em>далее, очевидно, должна быть представлена&nbsp;развёрнутая аргументация с ссылками на источники,&nbsp;почему именно Северная Корея такая по-боевому настроенная прям</em></p>\r\n', 1, 5, 1457104516);
